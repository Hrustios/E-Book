...
from Backend.extensions import mail  # Просто extensions, он лежит в той же папке
from Backend.login_register.auth_reg import auth_reg_bp  # Путь от текущего файла
